...
function SideBarUseList({ alluserToggle, setAlluserToggle }) {
  ...
  return (
    <>
      {!alluserToggle ? (
        <div className=" bg-[#111b21] flex justify-center p-3 mt-[1px]">
          <div
        ...
        <div
          className="w-full bg-[#005c4b] p-3 text-center text-gray-100 font-semibold hover:bg-green-800 transition-all duration-500 cursor-pointer"
