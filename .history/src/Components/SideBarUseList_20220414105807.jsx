  ...
  return (
    <>
      {!alluserToggle ? (
        ...
        <div
          className="w-96 bg-[#005c4b] p-3 text-center text-gray-100 font-semibold hover:bg-green-800 transition-all duration-500 cursor-pointer"
          onClick={() => setAlluserToggle((prv) => !prv)}
        >
          Friend List
        </div>
      )}
      <div
        className=" w-72 bg-[#005c4b] p-3 text-center text-gray-100 font-semibold hover:bg-green-800 transition-all duration-500 cursor-pointer "
        onClick={() => setAlluserToggle((prv) => !prv)}
      >
        Friend List
      </div>
