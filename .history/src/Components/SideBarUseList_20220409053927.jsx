  ...
  return (
    <div className="bg-[#111b21] overflow-y-scroll scroll-my-1 h-[94.1vh] scrollbar scrollbar-thumb-gray-400 scrollbar-thin text-gray-200 duration-500 transition-all">
      {array.map((i, index) => (
        <div
          key={index}
          className="px-4 py-3 pb-0 flex justify-start hover:bg-[#2a394279] cursor-pointer duration-500 transition-all relative"
        >
          ...
          <div className=" absolute px-5 bg-[#111b21] right-0 bottom-2">
            <BsChevronDown />
          </div>
        </div>
      ))}
