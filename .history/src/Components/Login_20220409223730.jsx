  ...
  return (
    <div className="w-full h-screen bg-[#0a1014]">
      ...
      <div className="flex justify-center text-gray-100 font-semibold">
        <div className="flex justify-between bg-[#222e35] p-3 space-x-3 mt-60 rounded-md cursor-pointer hover:bg-[#222e35b2] z-10">
          <FcGoogle className="my-auto" />
          <p>Registration</p>
        </div>
        <div className="absolute bottom-0 left-0  w-52 sm:w-90">
          <img src={one} alt="" />
        </div>
        <div className=" absolute bottom-0 right-0  w-52 sm:w-90">
          <img src={two} alt="" />
        </div>
      </div>
    </div>
