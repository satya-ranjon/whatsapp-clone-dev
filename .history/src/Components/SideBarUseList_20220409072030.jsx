...
export default function SideBarUseList() {
  ...
  return (
    <>
      ...
      <div className="bg-[#111b21] overflow-y-scroll scroll-my-1 h-[88.2vh] scrollbar scrollbar-thumb-gray-400 scrollbar-thin text-gray-200 duration-500 transition-all">
        {array.map((i, index) => (
          <div
            key={index}
